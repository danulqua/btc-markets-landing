  ...
  <UIContainer>
    ...
    >
      <div class="lg:w-[600px] xl:w-[660px]">
        <h1 class="text-6xl leading-[70px] lg:text-7xl lg:leading-[90px]">
          Buy, sell and trade crypto today
        </h1>
        <p class="mt-9 max-w-[440px] text-xl leading-8 text-dark-2">
        ...
        <div class="mt-8 flex space-x-4">
          ...
          <UIButton
            ...
            type="secondary"
            :size="breakpoints.isXs ? 'small' : 'large'"
            class="md:text-center lg:text-center xl:text-center"
          />
        </div>
